...
export const twitter = (
  <a title="Consulter notre page twitter" href="https://twitter.com/ZenikaIT" target="_blank">
    <i className="fab fa-twitter" title="Consulter notre page twitter" />
  </a>
)
