    ...
    <Page title="Mentions Légales" contextePage="Mentions Légales">
      <article className="container">
        <section>
          ...
          <p>Zenika est un cabinet d’innovation technologique, managériale et organisationnelle, qui accompagne les entreprises dans leur transformation numérique. C’est avant tout une entreprise qui a la capacité de s'adapter et de se positionner sur de nouveaux créneaux technologiques. Elle regroupe ainsi des profils variés sur les domaines d’expertise suivants : Java, Réalité Virtuelle, Intelligence Artificielle, BigData, Web, Mobilité, IoT, DevOps, Craftsmanship, Agilité, Sécurité et transformation des organisations.</p>
...
75009 Paris<br/>
        ...
        <section><h2>Conditions d’utilisation
        </h2>
